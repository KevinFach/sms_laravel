    ...
    <header class="w-full py-4 border-b border-neutral-200 bg-white sticky top-0 z-20">
        <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
            ...
            <nav class="flex items-center gap-6 text-sm">
                ...
                <a href="#contacto" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Contacto</a>
            </nav>
        </div>
    </header>
    ...
    <section class="pt-20 pb-24 bg-neutral-100" id="hero">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
            <div>
                ...
                <a href="#api" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 text-lg">Ver la API</a>
            </div>
            <div>
                <img src="https://cdn-icons-png.flaticon.com/512/1041/1041916.png" class="w-80 mx-auto" />
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto px-6 text-center">
            ...
            <div class="grid md:grid-cols-3 gap-10">
                <div class="border p-8 rounded-xl shadow-sm bg-white">
                    ...
                    <a href="#contacto" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700">Empezar</a>
                </div>
                ...
                <div class="border p-8 rounded-xl shadow-sm bg-white">
                    ...
                    <a href="#contacto" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700">Elegir plan</a>
                </div>
                ...
                <div class="border p-8 rounded-xl shadow-sm bg-white">
                    ...
                    <a href="#contacto" class="px-6 py-3 bg-neutral-900 text-white rounded-lg hover:bg-neutral-800">Contactar</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-neutral-100" id="contacto">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <form class="grid gap-4 max-w-lg mx-auto">
                <input type="text" placeholder="Nombre" class="border p-3 rounded-lg" />
                <input type="email" placeholder="Correo" class="border p-3 rounded-lg" />
                <textarea placeholder="Mensaje" class="border p-3 rounded-lg h-32"></textarea>
                <button class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700">Enviar</button>
            </form>
        </div>
    </section>
    <!-- TEAM -->
<!-- <section class="py-24 bg-white" id="equipo">
    <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            <div class="p-6 border rounded-xl shadow-sm">
                <h4 class="text-xl font-semibold">Leonardo Daniel Cruz Rosas</h4>
            </div>

            <div class="p-6 border rounded-xl shadow-sm">
                <h4 class="text-xl font-semibold">Kevin Fabian Chi</h4>
            </div>

            <div class="p-6 border rounded-xl shadow-sm">
                <h4 class="text-xl font-semibold">Uzziel Espinoza Calles</h4>
            </div>
        </div>
    ...
    <!-- FOOTER -->
    <footer class="py-6 text-center text-neutral-600 border-t">
        © 2025 MensajeríaAPI — Todos los derechos reservados.
    </footer>
